...
public class MainController implements Initializable, AbrirFormularioCallback {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/facturacion/fx/Menu/sidepanel.fxml"));
    ...
    private void loadSplashScreen() {
        try {
            FACTURACIONFX.isSplashLoaded = true;

            pane = FXMLLoader.load(getClass().getResource(("/facturacion/fx/Menu/splash.fxml")));
            ...
            fadeOut.setOnFinished((e) -> {
                try {
                    AnchorPane parentContent = FXMLLoader.load(getClass().getResource(("/facturacion/fx/Menu/main.fxml")));
    ...
    public void abrirFormulario(String nombreFormulario) {
        ...
        try {
            ...
            case "Productos":
                ...
                break;
//-------------Agregar aqui mas archivos FXML cuando avance mas el proyecto---------- 
            case "Clientes":
